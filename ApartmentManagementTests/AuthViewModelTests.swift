...
class AuthViewModelTests: XCTestCase {
    ...
    func testLoginSuccess() throws {
        ...
        viewModel.login(email: "admin@mail.com", password: "Pass1234")
    ...
    func testRegisterEmptyName() throws {
        ...
        viewModel.register(email: String(format: "test%@@mail.com", DateUtil.instance.getDate()), name: "", password: "Pass1234", role: Role.admin.rawValue)
    ...
    func testRegisterInvalidEmail() throws {
        ...
        viewModel.register(email: "a123", name: "Test", password: "Pass1234", role: Role.admin.rawValue)
    ...
    func testRegisterInvalidPassword() throws {
        ...
        viewModel.register(email: String(format: "test%@@mail.com", DateUtil.instance.getDate()), name: "Test", password: "asd", role: Role.admin.rawValue)
    ...
    func testRegisterEmptyRole() throws {
        ...
        viewModel.register(email: String(format: "test%@@mail.com", DateUtil.instance.getDate()), name: "Test", password: "Pass1234", role: "")
    ...
    func testRegisterSuccess() throws {
        ...
        viewModel.register(email: String(format: "test%@@mail.com", DateUtil.instance.getDate()), name: "Test", password: "Pass1234", role: Role.admin.rawValue)
