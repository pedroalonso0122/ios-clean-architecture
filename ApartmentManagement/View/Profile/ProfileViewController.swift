...
//
//  Created by Pedro Alonso on 2020/9/3.
...
class ProfileViewController: UIViewController, Alertable {
    ...
    */
    ...
    @IBAction func updateTapped(_ sender: Any) {
        ...
        guard let role = self.roleTextField.text, !role.isEmpty else{
        ...
        self.viewModel.update(id: userId, email: email, name: name, password: password, role: role)
    }
