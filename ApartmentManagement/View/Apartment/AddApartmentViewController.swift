...
class AddApartmentViewController: UIViewController, Alertable, UINavigationControllerDelegate {
    ...
    */
    ...
    @IBAction func saveTapped(_ sender: Any) {
        ...
        self.viewModel.add(name: name, description: description, floorAreaSize: size, price: price, numberOfRooms: numberOfRooms, country: country, locality: locality, address: address, latitude: latitude, longitude: longitude, image: imageData, status: status.rawValue)
    }
...
extension AddApartmentViewController: UITextFieldDelegate {
...
extension AddApartmentViewController {
...
extension AddApartmentViewController: UIImagePickerControllerDelegate {
...
extension AddApartmentViewController: GMSAutocompleteViewControllerDelegate {
  ...
  func viewController(_ viewController: GMSAutocompleteViewController, didAutocompleteWith place: GMSPlace) {
    ...
    if locality.isEmpty {
        locality = place.addressComponents?.first(where: { $0.types.contains("postal_town") })?.name ?? ""
    }
